   ...
   return(
    <div>
        {show ? <form onSubmit={handleCreate} >
            ...
            <div>Male:<input type="checkbox"onClick={()=>setNewGender("Male")} /><Col>Female:<input type="checkbox" onClick={()=>setNewGender('Female')} /></Col><Col>khác:<input type="checkbox" onClick={()=>setNewGender('khác')} /></Col></div>
